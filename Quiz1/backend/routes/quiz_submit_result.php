...
$pdo->prepare("INSERT INTO quiz_attempts(user_id,quiz_id,score,correct_count,total_questions,duration_seconds) VALUES(?,?,?,?,?,?)")
    ->execute([$user_id, $quiz_id, $score, $correct, $total, $duration]);
